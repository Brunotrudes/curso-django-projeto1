'''
listo abaixo as confguracoes usadas pelo Otavio miranda poara o VS code

Colocar essas informacoes no arquivo settings.json em configuracoes do vscode.

# instalar as extensoes
